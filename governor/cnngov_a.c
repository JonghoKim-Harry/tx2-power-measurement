...
static void cnngov_a_init(void *data);
static int32_t cnngov_a_get_target_freq();
static void cnngov_a_print_gpugov(int fd);

// Interface
struct gpugov cnngov_a = {

    .name = "gpugov-cnngov_a",
    .init = cnngov_a_init,
    .get_target_freq = cnngov_a_get_target_freq,
    .print_gpugov = cnngov_a_print_gpugov
};
