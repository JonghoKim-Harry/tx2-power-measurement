...
static void cnngov_d_init(void *data);
static int32_t cnngov_d_get_target_freq();
static void cnngov_d_print_gpugov(int fd);

// Interface
struct gpugov cnngov_d = {

    .name = "gpugov-cnngov_d",
    .init = cnngov_d_init,
    .get_target_freq = cnngov_d_get_target_freq,
    .print_gpugov = cnngov_d_print_gpugov
};
