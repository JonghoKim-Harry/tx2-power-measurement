...
static void cnngov_c_30_init(void *data);
static int32_t cnngov_c_30_get_target_freq();
static void cnngov_c_30_print_gpugov(int fd);

// Interface
struct gpugov cnngov_c_30 = {

    .name = "gpugov-cnngov_c_30",
    .init = cnngov_c_30_init,
    .get_target_freq = cnngov_c_30_get_target_freq,
    .print_gpugov = cnngov_c_30_print_gpugov
};
