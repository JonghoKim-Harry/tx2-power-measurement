...
static void cnngov_c_40_init(void *data);
static int32_t cnngov_c_40_get_target_freq();
static void cnngov_c_40_print_gpugov(int fd);

// Interface
struct gpugov cnngov_c_40 = {

    .name = "gpugov-cnngov_c_40",
    .init = cnngov_c_40_init,
    .get_target_freq = cnngov_c_40_get_target_freq,
    .print_gpugov = cnngov_c_40_print_gpugov
};
...
static int emc_up_threshold          = 400000;   // 40% (unit: x0.0001%)
