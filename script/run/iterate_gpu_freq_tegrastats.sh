...
help() {
    ...
    echo -e "\$2: Interval in ms"
    echo -e "\$3 ~ Last Argument: Caffe Command"
...
TEGRASTATS="$POWER_MEASUREMENT_HOME/tegrastats"
TEGRASTATS_SCRIPT="$POWER_MEASUREMENT_HOME/script/run/use_tegrastats.sh"
...
do
    ...
    $TEGRASTATS_SCRIPT $INTERVAL $STAT_FILE $SHELL_COMMAND
