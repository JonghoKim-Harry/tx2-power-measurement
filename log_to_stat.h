...
ssize_t elapsedtime_to_stat(const int stat_fd, const powerlog_summary_struct powerlog_summary);
ssize_t gpuenergy_to_stat(const int stat_fd, const powerlog_summary_struct powerlog_summary);
