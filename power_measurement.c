...
end_arg_processing:
    ...
    register_sysfs(info, &read_sysfs_1, &rawdata_to_stat_dot1, "GPU-Util(%)", "%*s", ONE_SYSFS_FILE, TX2_SYSFS_GPU_UTIL, TX2_SYSFS_GPU_UTIL_MAX_STRLEN);
    register_sysfs(info, &read_sysfs_1, &rawdata_to_stat_dot3, "GPU-Temp", "%*s", ONE_SYSFS_FILE, TX2_SYSFS_GPU_TEMP, TX2_SYSFS_GPU_TEMP_MAX_STRLEN);

#ifdef TRACE_MEM
    register_sysfs(info, &read_sysfs_1, &rawdata_to_stat_dot4, "EMC-Util(%)", "%*s", ONE_SYSFS_FILE, TX2_SYSFS_EMC_UTIL, TX2_SYSFS_GPU_UTIL_MAX_STRLEN);
